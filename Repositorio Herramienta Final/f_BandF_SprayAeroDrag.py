...
# }
# resistencias, trims, Vel_nudos = calcular_BandF_SprayAero(datos, 7.5, 25)
...
# np.savetxt('B&F_SprayAero.txt', np.array(resistencias), header='Total Resistance (N)')
# np.savetxt('B&F_SprayAero.txt', np.array(trims), header='Trim (degrees)')