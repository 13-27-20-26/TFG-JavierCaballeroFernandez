...
# }
# resistencias, trims, Vel_nudos = calcular_BlountandFox(datos, 7.5, 25)
...
# np.savetxt('B&F_Resistance.txt', np.array(resistencias), header='Total Resistance (N)')
# np.savetxt('B&F_Trims.txt', np.array(trims), header='Trim (degrees)')
